...
//        for (int i = 0; i < 100; i++) {
//            lock   = new DistributedLock("yun1:2181","lock");
//            lock.lock();
//            //共享资源
//            if (lock != null) {
//
...
//                System.out.println(i + "===" + j);
                executorService.submit(new ThreadTest(i, j));
...
//            ThreadTest t = new ThreadTest(i,  j);
//            Thread tt1 = new Thread(t);
//            tt1.start();
//            System.out.println(i + "----" + j);
//            ThreadTest t2 = new ThreadTest(i, j);
//            Thread tt2 = new Thread(t2);
//            tt2.start();
//            System.out.println(i + "----" + j);
//            ThreadTest t3 = new ThreadTest(i, j);
//            Thread tt3 = new Thread(t3);
//            tt3.start();
//            System.out.println(i + "----" + j);
//            ThreadTest t4 = new ThreadTest(i, j);
//            Thread tt4 = new Thread(t4);
//            tt4.start();
//            System.out.println(i + "----" + j);
//            ThreadTest t5 = new ThreadTest(i, j);
//
...
//                i++;
//                j--;
//                System.out.println(Thread.currentThread().getId() + "---->" + i + "=====局部变量结果=====>" + j);
////                if (lock != null) {
////                    lock.unlock();
////                }
//            }
